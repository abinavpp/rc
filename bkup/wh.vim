...
" Palette:
let s:pink         = "#89325d" "Include/Exception
let s:mongo        = "#5c5e00" "Boolean/Special
let s:aqua         = "#1e8d96" "Keyword
let s:green        = "#287a3b" "Type
let s:yellow       = "#ab6e08" "String
let s:orange       = s:mongo "StorageClass
let s:red          = "#de4638" "Number
let s:purple       = "#6b4993" "Repeat/Conditional
let s:blue         = "#5c60db" "Operator/Delimiter

" Extended:
let s:white			= "#ffffff"
let s:black			= "#000000"
let s:darkgrey		= "#606060"
let s:lightgrey		= "#9a9a9a"

let s:dullgreen		= "#5a805a"
let s:darkgreen		= "#00805a"
let s:greenleaf		= "#00801a"
let s:dullyellow	= "#dede9b"
let s:darkyellow	= "#dec837"

let s:easyred		= "#de0000"
let s:darkred		= "#800000"

let s:bluepurple	= "#9b9bde"
let s:teal			= "#075752"
let s:violet		= "#823e82"
let s:cheddar       = "#de7e38"

" Basic:
let s:foreground   = s:black
let s:background   = s:white
let s:nontext      = s:dullgreen
let s:window       = s:lightgrey
let s:divider      = s:lightgrey
let s:matchparen   = s:darkgreen
let s:linenumber   = s:darkgrey
let s:comment      = s:darkgrey
let s:todo         = s:dullgreen
let s:error        = s:easyred

" Cursor:
let s:cursor_fg    = s:black
let s:cursor_bg    = s:dullyellow
let s:cursor_im_fg = s:black
let s:cursor_im_bg = s:bluepurple
let s:cursorline   = s:lightgrey
let s:cursorcolumn = s:lightgrey

" ColorColumn:
let s:colorcolumn  = s:darkred

" Diff:
let s:difftext_bg  = s:violet
let s:diffadd_bg   = s:darkgreen
let s:diffdel_bg   = s:darkred
let s:diffmod_bg   = "#727272"

" Folded:
let s:folded_fg    = s:white
let s:folded_bg    = s:greenleaf

" PMenu:
let s:pmenu_fg     = s:white
let s:pmenu_bg     = s:black
let s:pmenu_sel_fg = s:white
let s:pmenu_sel_bg = s:teal
let s:pmenu_sbar   = s:teal
let s:pmenu_thumb  = s:black

" Search:
let s:search_fg    = s:white
let s:search_bg    = s:teal
let s:incsearch_fg = s:black
let s:incsearch_bg = s:darkyellow

" StatusLine:
let s:statusline_active_fg   = s:black
let s:statusline_active_bg   = s:cheddar
let s:statusline_inactive_fg = s:black
let s:statusline_inactive_bg = s:teal

" TabLine:
let s:tabline_bg          = s:teal
let s:tabline_active_fg   = s:white
let s:tabline_active_bg   = s:cheddar
let s:tabline_inactive_fg = s:black
let s:tabline_inactive_bg = s:teal

" Visual:
let s:visual_fg    = s:white
let s:visual_bg    = s:teal
...
call <SID>X("MatchParen", s:black, s:matchparen, "none")
...
call <SID>X("SpellBad", "", s:darkred, "bold")
...
call <SID>X("shFunction", s:yellow, "", "none")
